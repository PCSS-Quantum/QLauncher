...
`serve.sh` will serve the documentation files on http://localhost:8080. It will also build the documentation automatically if no html files are found (you will need to manually rebuild on changes).
